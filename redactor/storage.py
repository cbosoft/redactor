...
class DataStore:
    ...
    def __init__(self, output_dir: str, also_plot=True, prefix=''):
        ...
        self.data_output_name = f'{self.output_dir}/{self.prefix}raw_data.json'

        if os.path.exists(self.data_output_name):
            with open(self.data_output_name) as f:
    ...
    def save(self):
        with open(self.data_output_name, 'w') as f:
    ...
    def add_metadata(self, name: str, **metadata):
        ...
        self._data[name].update(**metadata)
